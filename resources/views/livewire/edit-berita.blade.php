<div>
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <div class="mt-3">
                <button wire:click="SimpanBerita" class="btn btn-warning btn-sm"><span class="mdi mdi-content-save"></span> Simpan</button>
            </div>
    ...
    <script>
        window.addEventListener('TambahBerhasil', () => {
            toastr.success(`Ubah Berita Berhasil`, 'success');
