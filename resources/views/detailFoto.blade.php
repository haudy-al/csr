    ...
    <section class="section section-sm bg-default">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="mb-3">
                        <img src="{{ asset('/storage/img/' . $data->gambar) }}" width="100%" alt="">
                    </div>
                    <div class="mb-3">
                ...
                <div class="col-md-4" style="text-align: left">
                    @php
                        $fotoLain = App\Models\GaleriFotoModel::where('id', '!=', $data->id)
                            ->inRandomOrder()
                            ->take(5)
                            ->get();
                    @endphp

                    @foreach ($fotoLain as $item)
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body p-0">
                                    <a href="/galeri/foto/detail/{{ $item->id }}">
