    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <a href="/admin/master/kategori-member/tambah" class="btn btn-primary btn-sm"><span class="mdi mdi-plus"></span>
                    Tambah</a>
            </div>
                        ...
                        <tbody>
                            @foreach ($data as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <form class="d-inline" action="/admin/master/kategori-member/hapus/{{ $item->id }}"
                                            method="POST">
                                            @csrf
                                            @method('delete')
                                        ...
                                        <a class="btn btn-warning btn-sm"
                                            href="/admin/master/kategori-member/edit?i={{ $item->id }}">
