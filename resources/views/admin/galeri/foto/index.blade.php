...
@section('content')
    <div class="container-fluid">
        <div class="mb-3">
            <a href="/admin/galeri/foto/tambah" class="btn btn-primary btn-sm"><span class="mdi mdi-plus"></span> Tambah</a>
        </div>
                ...
                <div class="card">
                    <div class="el-card-item">
                        ...
                        <div class="el-card-content">
                            <form class="d-inline" action="/admin/galeri/foto/hapus/{{ $item->id }}" method="POST">
                                @csrf
                                @method('delete')
                            ...
                            <a class="btn btn-warning btn-sm" href="/admin/galeri/foto/edit?i={{ $item->id }}">
